...
<head>
    ...
    <title><?php echo $translations[$lang]['forgot_password_title']; ?> - LIMS</title>
        ...
        <div class="container">
            <div class="row g-5 justify-content-center">
                <div class="col-md-6 card" data-aos="fade-up">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo $translations[$lang]['forgot_password_title']; ?></h5>
                        <?php if (isset($_SESSION['success'])): ?>
                            <div class="alert alert-success" role="alert">
                                <?php 
                                echo htmlspecialchars($translations[$lang]['success_message']); 
                        ...
                        <form action="send-password-reset.php" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="email" class="form-label">
                                    <?php echo $translations[$lang]['email_label']; ?>
                                </label>
                                <input type="email" name="email" id="email" class="form-control" 
                                       placeholder="<?php echo $translations[$lang]['email_placeholder']; ?>" 
                                       required>
                            </div>
                            <button type="submit" class="btn btn-primary">
                                <?php echo $translations[$lang]['submit_button']; ?>
                            </button>
                        </form>
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="footer-links">
                    <?php foreach (['home', 'about', 'gallery', 'announcements'] as $section): ?>
                        <a href="/../index.php?php echo $section; ?>" class="footer-link"><i class="fas fa-<?php echo $section === 'home' ? 'home' : ($section === 'about' ? 'info-circle' : ($section === 'gallery' ? 'image' : 'bullhorn')); ?>"></i> <?php echo $translations[$lang][$section]; ?></a>
                    <?php endforeach; ?>
                </div>
            </div>
            <div>
                ...
                <div class="language-switcher">
                    <a href="?lang=om" class="language-btn <?php echo $lang === 'om' ? 'active' : ''; ?>">Afaan Oromoo</a>
