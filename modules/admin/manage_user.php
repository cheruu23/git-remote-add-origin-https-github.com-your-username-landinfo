...
logAction('manage user ', 'admin can access  manage user page ', 'info');
                ...
                <tbody>
                    <?php foreach ($users as $user): ?>
                        <tr>
                            ...
                            <td><img src="<?php echo BASE_URL . '/' . htmlspecialchars($user['photo']); ?>" alt="User Photo" class="profile-pic" onerror="this.src='<?php echo BASE_URL; ?>/assets/images/default_profile.png'"></ aretd>
